  ...
  async task() {
    ...
    try {
      ...
      if (namespace.app) { // Express app for configuration
        ...
        // Testing API
        namespace.express('get', 'test', async (res:any) => { 
          res.send("API TESTING PAGE, GO TO /get-linktree")
        })
        
        // * GET API: get all Linktrees data
        namespace.express('get', '/get-linktree', async (res: any) => {  
          try {
        ...
        // TODO: POST API: generate a new linktree
        namespace.express('post', '/generate',async (req: object, res: any) => {
          
        })

        // TODO: POST API: update a exist linktree
